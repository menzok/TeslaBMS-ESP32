 ...
 */
 ...
 /* (incase you want to check my work, heres the raw data.)
  * RAW OCV DATA FROM HPPC REST PERIODS (m1000 cell - 2170 NCA)
  * End-of-rest voltages only (no interpolation)
  * Source: McMaster University Tesla/Panasonic 2170 dataset
  *
  * SOC (%)   -10°C     10°C      25°C      40°C
  * -------------------------------------------------
  * 100.0     4.1624    4.1664    4.1797    4.1891
  * 95.6      4.0929    -         -         -
  * 95.3      -         4.1012    -         -
  * 95.1      -         -         4.1231    4.1269
  * 91.3      4.0705    -         -         -
